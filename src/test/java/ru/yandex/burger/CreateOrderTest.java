...
public class CreateOrderTest {
    ...
    @Description("Заказ не создан, код ответа 400. ЗАМЕЧАНИЕ: согласно спеке - без авторизации не должен создаваться заказ, но по факту обратное. Тест будет падать" )
